...
const ClaudeButton: React.FC<ClaudeButtonProps> = ({ className = '' }) => {
  ...
  return (
    <>
      <button
        onClick={openModal}
        className={`flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 ${className}`}
      >
        <svg 
